...
// Package generator defines an interface for code generator to implement.
//
...
// with, and then you'll call one for more of the Execute methods. See the
// interface definitions for explanations. All output will have gofmt called on
// automatically, so you do not need to worry about generating correct
// indentation.
//
// This package also expose SnippetWriter. SnippetWriter reduces to a minimum
