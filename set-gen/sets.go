...
//
// We could use t directory as the argument, but doing it this way makes it easy
...
// string arrays and internal sets, and conversion logic requires public today.
type Empty struct{}
`

// Written for every type. If you've never used text/template before:
// $.type$ refers to the source type; |public means to
// call the function giving the public name, |raw he raw type name.
